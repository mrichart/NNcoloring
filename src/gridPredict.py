...
pipeline = pickle.load (open ('pkls/grid_patch' + str(patch_size[0]) + 'x' + str (patch_size[1])+'_som' + str(som_size[0]) + 'x' + str (som_size[1])+'.pkl', 'rb'))
...
for filename in os.listdir(image_dir):
    if filename.endswith(".jpg"):
        ...
        pos = 0
        for j in range(0, 256-patch_size[0]+1, 1):    # con patch 5x5: range(0, 252, 1)
        ...
        imgGrey = imgGrey[(patch_size[0]//2):(256-patch_size[0]//2), (patch_size[1]//2):(256-patch_size[1]//2)]     # con patch 5x5: [2:254,2:254]
